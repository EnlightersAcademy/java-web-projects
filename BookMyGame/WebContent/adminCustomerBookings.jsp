        ...
        <div class="page-content--bgf7" style="height: 100%">
        	...
        	<div class="jumbotron" style="width: 80%; margin: auto; text-align: center;">
				<form class="form-inline" style="margin: auto;">
					 ...
					 <div class="col-auto">
					 	<button type="submit" class="btn btn-primary mb-2"> Search Member </button>
					 </div>
				</form>								
			</div>
			<br/>
        	...
        	<div style="width: 80%; margin: auto; text-align: center;">
			  	<div class="form-group row">
				    <label class="col-sm-2 col-form-label" style="font-weight: bold;">Member ID: </label>
				    <div class="col-sm-10">
