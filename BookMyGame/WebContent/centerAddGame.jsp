        ...
        <div class="page-content--bgf7" style="height: 100%">
        	...
        	<br/>
        	 <%
        		...
        		if(request.getParameter("result")!=null && "success".equals(request.getParameter("result"))) {
        	...
        	<div class="jumbotron" style="width: 50%; margin: auto;">
			  ...
			  <br/>
				...
				<form action="center/update/sports" method="post">
                  ...
                  <br/>
				  <button type="submit" class="au-btn au-btn--block au-btn--green m-b-20">Add New Game</button>
				</form>
			</div>
