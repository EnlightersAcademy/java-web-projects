        	...
        	<div style="width: 90%; margin: auto; text-align: center;">
			  	<div class="form-group row">
				    ...
				    <div class="col-sm-10">
				      ...
				      <input type="text" readonly class="form-control-plaintext" name="selectedLocation" value="<%= request.getAttribute("locationName") %>">
				    </div>
				  </div>		
			</div>
                ...
                <table class="table table-borderless table-data3">
                    ...
                    %>
                        <tr>
                            ...
                            <td><%=center.getTwoWheelerparkingAvailability() %></td>
                            <td><%=center.getFourWheelerParkingAvailability() %></td>
                            <td><%=center.getSports().toString() %></td>
                            <td>
                            	<a href="userBookGame1.jsp?centerId=<%=center.getSportCenterId() %>" class="btn btn-success mb-2">SELECT</a>	<!-- Populate the sportsCenterId in HREF-->
							</td>
                        </tr>
