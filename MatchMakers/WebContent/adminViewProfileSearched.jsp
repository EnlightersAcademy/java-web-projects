			...
			<section class="statistic">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                    	<a href="adminSearchResults.jsp" class="btn btn-warning btn-sm" style="float: right;">
                        ...
                        <!-- Block Section not needed if status is INACTIVE or MARRIED -->
	           			<form action="" method="post">
	                            	<input type="hidden" value="<%= 1234 %>">	<!-- Populate the User ID here for submission -->
	                             <button type="submit" class="btn btn-outline-danger btn-sm">
	                                 <i class="fa fa-ban"></i> Block This Profile</button>
	                            </form>
	                    <!-- ---------- -->
